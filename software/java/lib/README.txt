The Finch software package relies on a number of third-party open source packages, including:
   ...
   * JNAerator (http://code.google.com/p/jnaerator/)
     - Used to generate JNA interfaces for the native Mac OS USB drivers to communicate over USB with Finch.
...
of the GNU GPL v2 license.  Please see the separate license files for details on licensing for all other libraries.